...
class Coderobot {
  ...
  async errorResult(result) {
    ...
    : console.error(`A result status of '${result.status}' was returned.`))
  }
  /**
  ...
  async command(question) {
    ...
    async function completePrompt(input) {
      ...
      switch (result.status) {
        ...
        default: {
          console.error(
            `${result.status}: ${result.message || "An error occurred"}`
          )
          break
        }
      }
      ...
      async function completePrompt(input) {
        ...
        switch (result.status) {
          ...
          default: {
            ...
            : respond(`A result status of '${result.status}' was returned.`))
            break
          }
        }
      }
